...
include($_SERVER['DOCUMENT_ROOT'] . '/Rombooking-system-/Controllers/ReservationController.php'); // Include the Reservation class
$userReservations = new ReservationController($conn);
                ...
                <?php foreach ($reservations as $reservation): ?>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            <?php if ($isCancelable): ?>
                                <button class="bg-red-500 text-white px-2 py-1 rounded cancel-btn"
                                    data-reservation-id="<?php echo htmlspecialchars($reservation['ReservasjonID']); ?>">
                                    Avbestill
                                </button>
                            <?php else: ?>
...
<div id="confirmationModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center">
    <div class="bg-white p-6 rounded-md">
        ...
        <form id="cancelForm" method="post" action="/Rombooking-system-/routes.php">
